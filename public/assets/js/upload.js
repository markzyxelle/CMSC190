        ...
        $.ajax({
            ...
            success : function(data) {
                ...
                $.each(data, function(x, item) {
                    ...
                    if(x != 0){
                        (item[28] ? approved++ : rejected++);
                        $("#client-summary-table tbody").append("<tr" + (item[28] ? "" : " class='false'") + "><td "+ (item[0] ? "" : "class='false'") +">" + item[1] + "</td><td "+ (item[2] ? "" : "class='false'") +">" + item[3] + "</td><td "+ (item[4] ? "" : "class='false'") +">" + item[5] + "</td><td "+ (item[6] ? "" : "class='false'") +">" + item[7] + "</td><td "+ (item[8] ? "" : "class='false'") +">" + item[9] + "</td><td "+ (item[10] ? "" : "class='false'") +">" + item[11] + "</td><td "+ (item[12] ? "" : "class='false'") +">" + item[13] + "</td><td "+ (item[14] ? "" : "class='false'") +">" + item[15] + "</td><td "+ (item[16] ? "" : "class='false'") +">" + item[17] + "</td><td "+ (item[18] ? "" : "class='false'") +">" + item[19] + "</td><td "+ (item[20] ? "" : "class='false'") +">" + item[21] + "</td><td "+ (item[22] ? "" : "class='false'") +">" + item[23] + "</td><td "+ (item[24] ? "" : "class='false'") +">" + item[25] + "</td><td "+ (item[26] ? "" : "class='false'") +">" + item[27] + "</td></tr>");
                    }
            ...
            success : function(data) {
                ...
                $.each(data, function(x, item) {
                    if(x != 0){
                        ...
                        if(item["transactions"].length > 0) $("#loan-summary-table tbody").append("<tr class='transaction-row' data-id='" + x + "'><td colspan='3'>ID</td><td colspan='2'>Principal Paid</td><td colspan='2'>Interest Paid</td><td colspan='3'>Payment Date</td><td colspan='3'>Due Date</td></tr>");
                        $.each(item["transactions"], function(i, temp) {
                            $("#loan-summary-table tbody").append("<tr class='transaction-row" + (temp[10] ? "" : " false") + "' data-id='" + x + "'><td colspan='3' "+ (temp[0] ? "" : " class='false'") +">" + temp[1] + "</td><td colspan='2' "+ (temp[2] ? "" : " class='false'") +">" + temp[3] + "</td><td colspan='2' "+ (temp[4] ? "" : " class='false'") +">" + temp[5] + "</td><td colspan='3' "+ (temp[6] ? "" : " class='false'") +">" + temp[7] + "</td><td colspan='3' "+ (temp[8] ? "" : " class='false'") +">" + temp[9] + "</td></tr>");
                            (temp[10] ? transactionApproved++ : transactionRejected++);
                            // alert("Client " + x + " has transaction details " + temp);
