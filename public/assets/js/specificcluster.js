						...
						case 3:
							...
							if(data["data"].length == 0) $("#search-results-table tbody").html("<strong>The client has no records in this cluster</strong>");
								...
								$.each( data["data"], function( key, value ) {
									...
									$("#search-results-table tbody").append("<tr><td></td><td>Branch</td><td>Loan Type</td><td>Loan Cycle</td><td>Loan Amount</td><td>Maturity Date</td><td>Status</td><td>As Of</td></tr>");
