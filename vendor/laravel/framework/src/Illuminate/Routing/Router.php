...
class Router implements RegistrarContract
{
    ...
    public function auth()
    {
        ...
        $this->post('register', 'Auth\AuthController@register');            //Route for Creation of Company
        $this->post('register-user', 'Auth\AuthController@registerUser');   //Route for Creation of User without Company
