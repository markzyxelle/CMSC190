                ...
                $.each(data, function(x, item) {
                    if(x != 0){
                        ...
                        $.each(item["transactions"], function(i, temp) {
                            $("#loan-summary-table tbody").append("<tr class='transaction-row" + (temp[11] ? "" : " cutoff-date-error") + (temp[10] ? "" : " false") + "' data-id='" + x + "'><td colspan='3' "+ (temp[0] ? "" : " class='false'") +">" + temp[1] + "</td><td colspan='2' "+ (temp[2] ? "" : " class='false'") +">" + temp[3] + "</td><td colspan='2' "+ (temp[4] ? "" : " class='false'") +">" + temp[5] + "</td><td colspan='3' "+ (temp[6] ? "" : " class='false'") +">" + temp[7] + "</td><td colspan='3' "+ (temp[8] ? "" : " class='false'") +">" + temp[9] + "</td></tr>");
