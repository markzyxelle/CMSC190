                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form id="upload-client-csv" class="form-horizontal" role="form" data-url="{{URL::to('/clientsCSV')}}">
                                                ...
                                                <div>
                                                    ...
                                                    <input style="margin:1%;" class="btn btn-info btn-md" type="submit" value="Validate Client File" name="submit"><span id="client-spinner"><i class="fa wobble-fix fa-spin fa-spinner"></i><span>    Loading...</span></span>
                                                </div>
                                            </form>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form id="upload-loan-csv" class="form-horizontal" role="form" data-url="{{URL::to('/loansCSV')}}">
                                                ...
                                                <div>
                                                    ...
                                                    <input style="margin:1%;" class="btn btn-info btn-md" type="submit" value="Validate Loan File" name="submit"><span id="loan-spinner"><i class="fa wobble-fix fa-spin fa-spinner"></i><span>    Loading...</span></span>
                                                </div>
                                            </form>
