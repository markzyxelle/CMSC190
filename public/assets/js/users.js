 ...
 //  //textStatus contains the status: success, error, etc
	...
	$.getJSON( "/getPendingUsers/0" , function( resp ) {
	    ...
	    $.each( resp, function( key, value ) {
	    	...
	    	htmlInside += value['email']
	    	htmlInside += "</td>"
	    	htmlInside += "<td><button type='button' class='btn btn-info btn-sm modal-button' data-toggle='modal' data-target='#branchModal' data-value='"+ value['id'] +"'>Approve User</button></td>"
	        htmlInside += "<tr>"
	    });
