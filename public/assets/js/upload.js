    ...
    $('#upload-loan-csv').submit(function(e){
        ...
        $.ajax({
            ...
            success : function(data) {
                ...
                if(valid == true){
                    $("#loan-upload-status").append("<div class='alert alert-info'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>Data as of <strong>" + data[0][0] + ".</strong></div><div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>" + loanApproved + "</strong> loan rows have correct format.</div><div class='alert alert-danger'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>" + loanRejected + "</strong> loan rows does not have correct format.</div><div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>" + transactionApproved + "</strong> transaction rows have correct format.</div><div class='alert alert-danger'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>" + transactionRejected + "</strong> transaction rows does not have correct format.</div>");
